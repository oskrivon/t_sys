...
**ИТОГ ЛЕДОКОЛА:** селекция реальна (favorable-excursion, WR), извлекаемого PnL нет — все честные механизмы входа (raw-touch, tape-gate, book-gate, confirm-continuum) ≤ безубытка. Единая суб-комиссионная/геометрическая стена убила все ветки. Новое: `icebreaker_book_gate.py`, `icebreaker_confirm_sweep.py`, `ts_cross/side/level` в `levelcross`. Детали: [ICEBREAKER_RESEARCH.md](ICEBREAKER_RESEARCH.md) Фаза 2.
