...
- [ ] Paper trading + чувствительность к фи-тиру/слиппеджу, sizing/частота
      *(прайор после tape-чека: закладывать haircut/слиппедж ближе к 10bps для high-mom входов; эдж тонкий)*
