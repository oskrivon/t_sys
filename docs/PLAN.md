...
- [ ] **(а) Maker fill-risk / adverse-selection — решающий тест.** Смоделировать честное
  лимитное исполнение: заполняешься только если цена реально прошла лимитку, + adverse
  selection (на пробое наливают чаще когда он фейлит). Переживает ли +0.08%/сделку? Это
  гейт: maker-only эдж без fill-модели недоказуем.
