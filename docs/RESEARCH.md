...
- **Icebreaker (Wall-Eating)** — **DEAD**. Их бэктест +10.75% не воспроизводится. Faithful-тест март-2026 на free Bybit (абсорбция через трейды + комиссии): TAO −4.21% (WR 6%, 16 SL:1 TP — анти-предсказательно), ZEC −2.69%, SUI −1.23%, SIREN ~0 сигналов. Лучший gross ≈0 (SUI +0.20%) → комиссии добивают (breakeven 0.041%/сделку vs taker 0.11%). Их эдж был артефактом KuCoin lv50 + отсутствия комиссий. Актив: 8.8GB единого parquet-store (Bybit L2+trades март-2026) + инфра (ветка `icebreaker-collector`, 97 тестов). [Детали](ICEBREAKER_RESEARCH.md)
